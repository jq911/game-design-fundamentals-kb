...
OUT_DIR = ROOT / "ocr_pages" / "chapter06"
OUT_MD = ROOT / "ocr_pages" / "chapter06_raw.md"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Chapter 6 printed pp. 96-106 maps to PDF pages 115-125 because printed page = PDF page - 19.
START_PDF, END_PDF = 115, 125
PRINTED_OFFSET = 19
