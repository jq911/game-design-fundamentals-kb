...
OUT_DIR = ROOT / "ocr_pages" / "chapter09"
OUT_MD = ROOT / "ocr_pages" / "chapter09_raw.md"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Chapter 9 printed pp. 142-153 maps to PDF pages 161-172 because printed page = PDF page - 19.
START_PDF, END_PDF = 161, 172
PRINTED_OFFSET = 19
