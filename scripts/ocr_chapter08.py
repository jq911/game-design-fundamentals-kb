...
OUT_DIR = ROOT / "ocr_pages" / "chapter08"
OUT_MD = ROOT / "ocr_pages" / "chapter08_raw.md"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Chapter 8 printed pp. 118-141 maps to PDF pages 137-160 because printed page = PDF page - 19.
START_PDF, END_PDF = 137, 160
PRINTED_OFFSET = 19
