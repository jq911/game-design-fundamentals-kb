...
OUT_DIR = ROOT / "ocr_pages" / "chapter07"
OUT_MD = ROOT / "ocr_pages" / "chapter07_raw.md"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Chapter 7 printed pp. 107-117 maps to PDF pages 126-136 because printed page = PDF page - 19.
START_PDF, END_PDF = 126, 136
PRINTED_OFFSET = 19
