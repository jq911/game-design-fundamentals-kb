...
OUT_DIR = ROOT / "ocr_pages" / "chapter10"
OUT_MD = ROOT / "ocr_pages" / "chapter10_raw.md"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Chapter 10 printed pp. 154-176 maps to PDF pages 173-195 because printed page = PDF page - 19.
START_PDF, END_PDF = 173, 195
PRINTED_OFFSET = 19
